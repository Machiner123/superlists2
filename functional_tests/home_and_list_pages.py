...
class HomePage(object):
    """
    1: initialied with something we can refer to easily(self.test.server_url)
    2: notice wait_for to avoid race conditions
    3: enables method chaining (semi functional programming)
    4: text input goes into appropriate place on homepage, but
    5: we instantiate a test on list page
    6: run wait for on new list page before validating
    7: then return the list page, not homepage
    """
